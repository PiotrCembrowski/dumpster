...
export const metadata: Metadata = {
  title: "Dumpster Rental Tampa FL | Same Day Roll Off Dumpster Tampa",
  description:
    "Affordable dumpster rental in Tampa, FL. 10, 20, 30, 40 yard dumpsters available. Same-day delivery in Brandon, Riverview, Clearwater & Tampa metro.",
  keywords: [
    "dumpster rental tampa",
    "tampa dumpster rental",
    "roll off dumpster tampa",
    "cheap dumpster tampa",
    "construction dumpster tampa",
    "residential dumpster tampa",
  ],
};
...
const benefits = [
  {
    ...
    description: "Fast dumpster delivery across Tampa metro area",
  },
  {
    icon: Clock,
...
export default function TampaDumpsterPage() {
  return (
    <>
      {/* Schema */}
      <script
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="max-w-3xl">
            ...
            <p className="mt-6 text-lg text-muted-foreground">
              Affordable dumpster rental in Tampa, Florida. We provide fast
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-3xl font-bold text-center">
            Dumpster Sizes Available in Tampa
          </h2>
      ...
      <section className="py-20 bg-muted">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-3xl font-bold text-center">
            Why Choose Our Tampa Dumpster Rental
          </h2>
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-6">
          <h2 className="text-3xl font-bold mb-6">
            Roll Off Dumpster Rental Tampa
          </h2>

          <p className="text-muted-foreground mb-4">
            Our Tampa dumpster rental services are ideal for construction, home
            cleanouts, demolition, roofing projects, and commercial waste
            removal. We deliver roll-off dumpsters quickly across Tampa and
            surrounding areas.
          </p>

          <p className="text-muted-foreground mb-4">
            Whether you're renovating your home, managing a construction site,
            or cleaning out a property, our dumpsters help make waste removal
            simple and efficient.
          </p>

          <p className="text-muted-foreground">
            Serving Tampa, Brandon, Riverview, Clearwater, St. Petersburg, and
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="max-w-3xl">
            <h2 className="text-3xl font-bold">
              Get a Free Dumpster Rental Quote in Tampa
            </h2>
