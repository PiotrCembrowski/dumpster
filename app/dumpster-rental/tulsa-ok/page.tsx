...
import { Phone, CheckCircle, Truck, Clock, Shield, MapPin } from "lucide-react";

export const metadata: Metadata = {
  title: "Dumpster Rental Tulsa OK | Same Day Roll Off Dumpster Tulsa",
  description:
    "Affordable dumpster rental in Tulsa, OK. 10, 20, 30, 40 yard dumpsters available. Same-day delivery in Broken Arrow, Jenks, Owasso & Tulsa metro.",
  keywords: [
    "dumpster rental tulsa",
    "tulsa dumpster rental",
    "roll off dumpster tulsa",
    "cheap dumpster tulsa",
    "construction dumpster tulsa",
    "residential dumpster tulsa",
  ],
};
...
const benefits = [
  {
    ...
    description: "Fast dumpster delivery across Tulsa metro area",
  },
  {
    icon: Clock,
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="max-w-3xl">
            ...
            <p className="mt-6 text-lg text-muted-foreground">
              Affordable dumpster rental in Tulsa, Oklahoma. We provide fast
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-3xl font-bold text-center">
            Dumpster Sizes Available in Tulsa
          </h2>
      ...
      <section className="py-20 bg-muted">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-3xl font-bold text-center">
            Why Choose Our Tulsa Dumpster Rental
          </h2>
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-6">
          <h2 className="text-3xl font-bold mb-6">
            Roll Off Dumpster Rental Tulsa
          </h2>

          <p className="text-muted-foreground mb-4">
            Our Tulsa dumpster rental services are perfect for construction,
            home cleanouts, demolition, and commercial projects. We provide fast
            delivery across Tulsa and surrounding areas.
          </p>

          <p className="text-muted-foreground mb-4">
            Whether you're remodeling your home or managing a construction site,
            our roll-off dumpsters make waste removal simple and efficient.
          </p>

          <p className="text-muted-foreground">
            Serving Tulsa, Broken Arrow, Jenks, Owasso, Bixby, and surrounding
            communities.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="max-w-3xl">
            <h2 className="text-3xl font-bold">
              Get a Free Dumpster Rental Quote in Tulsa
            </h2>
