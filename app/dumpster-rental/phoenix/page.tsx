...
export const metadata: Metadata = {
  title: "Dumpster Rental Phoenix AZ | Same Day Roll Off Dumpster Phoenix",
  description:
    "Affordable dumpster rental in Phoenix, AZ. 10, 20, 30, 40 yard dumpsters available. Same-day delivery in Scottsdale, Mesa, Tempe & Phoenix metro.",
  keywords: [
    "dumpster rental phoenix",
    "phoenix dumpster rental",
    "roll off dumpster phoenix",
    "cheap dumpster phoenix",
    "construction dumpster phoenix",
    "residential dumpster phoenix",
  ],
};
...
const benefits = [
  {
    ...
    description: "Fast dumpster delivery across Phoenix metro area",
  },
  {
    icon: Clock,
...
export default function PhoenixDumpsterPage() {
  return (
    <>
      {/* Schema */}
      <script
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="max-w-3xl">
            ...
            <p className="mt-6 text-lg text-muted-foreground">
              Affordable dumpster rental in Phoenix, Arizona. We provide fast
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-3xl font-bold text-center">
            Dumpster Sizes Available in Phoenix
          </h2>
      ...
      <section className="py-20 bg-muted">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-3xl font-bold text-center">
            Why Choose Our Phoenix Dumpster Rental
          </h2>
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-6">
          <h2 className="text-3xl font-bold mb-6">
            Roll Off Dumpster Rental Phoenix
          </h2>

          <p className="text-muted-foreground mb-4">
            Our Phoenix dumpster rental services are ideal for construction,
            home renovations, roofing jobs, and commercial cleanouts. We deliver
            roll-off dumpsters quickly across the Phoenix metro area.
          </p>

          <p className="text-muted-foreground mb-4">
            Whether you're managing a construction project or cleaning out a
            property, our dumpsters help you remove waste efficiently and
            affordably.
          </p>

          <p className="text-muted-foreground">
            Serving Phoenix, Scottsdale, Mesa, Tempe, Glendale, Chandler, and
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="max-w-3xl">
            <h2 className="text-3xl font-bold">
              Get a Free Dumpster Rental Quote in Phoenix
            </h2>
